Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "VERSION.yml", "lib/jewelry_portfolio", "lib/jewelry_portfolio/repo.rb", "lib/jewelry_portfolio/repos_index.rb", "lib/jewelry_portfolio/tasks.rb", "lib/jewelry_portfolio/template", "lib/jewelry_portfolio/template/feed.rb", "lib/jewelry_portfolio/template/html.rb", "lib/jewelry_portfolio/template.rb", "lib/jewelry_portfolio.rb", "test/fixtures", "test/fixtures/alloy.github.com", "test/fixtures/alloy.github.com/feed.xml", "test/fixtures/alloy.github.com/feed.xml.builder", "test/fixtures/alloy.github.com/index.html", "test/fixtures/alloy.github.com/repos.yml", "test/fixtures/alloy.github.com/template.html.erb", "test/fixtures/alloy.github.com.tgz", "test/fixtures/dr-nic-magic-awesome.gemspec_", "test/fixtures/dr-nic-magic-awesome.html", "test/fixtures/dr-nic-magic-awesome_repo.yml", "test/fixtures/feed.xml", "test/fixtures/feed.xml.builder", "test/fixtures/microgem.gemspec_", "test/fixtures/repos.yml", "test/fixtures/template.html", "test/fixtures/template.html.erb", "test/jewelry_portfolio_test.rb", "test/repo_test.rb", "test/repos_index_test.rb", "test/tasks_test.rb", "test/template_test.rb", "test/test_helper.rb", "test/tmp", "test/tmp/alloy.github.com.git", "test/tmp/alloy.github.com.git/feed.xml", "test/tmp/alloy.github.com.git/feed.xml.builder", "test/tmp/alloy.github.com.git/index.html", "test/tmp/alloy.github.com.git/repos.yml", "test/tmp/alloy.github.com.git/template.html.erb"]
  s.has_rdoc = true
