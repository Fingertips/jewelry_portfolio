...
Because that's exactly what this gem does.

Note that JewelryPortfolio _can_ be used without Jeweler. Simply define all
attributes as described in "GitHub pages repository: Rakefile"
...
http://github.com/Fingertips/fingertips.github.com/tree/master, which
creates the following: http://fingertips.github.com/</em>):
...
jewelry portfolio (<em>note that it isn't necessary to use Jeweler to be able
to use JewelryPortfolio</em>) like so:
